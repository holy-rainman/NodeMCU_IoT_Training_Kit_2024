...
#define BLYNK_AUTH_TOKEN "REPLACE_WITH_YOUR_AUTH TOKEN"
...
String apiKey = "REPLACE_WITH_YOUR_APIKEY_WHATSAPP";

// Initialize Telegram BOT
#define BOTtoken "xxxxxxxxxx:xxxxxxxxxxxxxxxxxxxxxxxxxxxxx_REPLACE_WITH_YOUR_TELEGRAM_BOT_TOKEN"  // your Bot Token (Get from Botfather)
